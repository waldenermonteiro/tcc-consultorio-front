export default function () {
  return {
    ...
    columns: [
      ...
      { name: 'actions', align: 'right', label: 'Ações', field: 'actions', headerStyle: 'width: 130px' }
    ],
    columnsListOfMedic: [
      { name: 'id', align: 'center', label: 'Id', field: 'id', sortable: true },
      { name: 'name', align: 'center', label: 'Descrição', field: 'name', sortable: true },
      ...
      { name: 'patient', align: 'center', label: 'Paciente', field: 'patient', sortable: true },
      { name: 'status', align: 'center', label: 'Status', field: 'status', sortable: true },
      { name: 'actions', align: 'right', label: 'Ações', field: 'actions', headerStyle: 'width: 100px' }
    ],
    columnsHistoryPatient: [
      { name: 'id', align: 'center', label: 'Id', field: 'id', sortable: true },
      { name: 'date_appointment', align: 'center', label: 'Data da Consulta', field: 'date_appointment', sortable: true },
      { name: 'status', align: 'center', label: 'Status', field: 'status', sortable: true },
      { name: 'actions', align: 'right', label: 'Ações', field: 'actions', headerStyle: 'width: 50px', sortable: true }
    ]
  }
}
